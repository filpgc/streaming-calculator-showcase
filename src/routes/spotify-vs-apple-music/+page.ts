...
export const load: PageLoad = async () => {
	...
	const b = platforms['apple-music'];
	const url = 'https://streamingcalculator.com/spotify-vs-apple-music';

	return {
		platformA: a,
		platformB: b,
		editorial: await loadEditorial('comparison', 'spotify-vs-apple-music'),
