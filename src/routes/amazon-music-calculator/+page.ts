...
export const load: PageLoad = async () => {
	const platform = platforms['amazon-music'];
	const url = 'https://streamingcalculator.com/amazon-music-calculator';

	return {
		platform,
		editorial: await loadEditorial('platform', 'amazon-music'),
