...
<table>
  <tr>
    <td width="50%">
      <img src="docs/calculator.webp" alt="Multi-platform streaming royalty calculator" />
    </td>
    <td width="50%">
      <img src="docs/distributor-comparison.png" alt="Music distributor cost comparison" />
    </td>
  </tr>
  <tr>
    <td><sub>Multi-platform royalty calculations with live per-platform results.</sub></td>
    <td><sub>Distributor costs compared against each creator's actual release model.</sub></td>
  </tr>
</table>
